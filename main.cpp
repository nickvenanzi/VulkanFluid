...
private:
    void initWindow()
    {
        ...
        glfwWindowHint(GLFW_RESIZABLE, GLFW_FALSE); // Temp. disable resizing windows

        window = glfwCreateWindow(WIDTH, HEIGHT, "Vulkan Hooyah", nullptr, nullptr);
    }
    ...
    void drawFrame()
    {
        ...
        VkSemaphore signalSempahores[] = {renderFinishedSemaphore};
